...
df.plot(label=['Pewdiepie','JuegaGerman','Fernanfloo','Mikecrack','JessNoLimit','MrBeastGaming','TotalGaming','TechnoGamerz','Markiplier','jacksepticeye'], color=['red','cyan','green','yellow','lime','blue','black','gold','crimson','chartreuse'], kind="line")
